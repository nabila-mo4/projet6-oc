...
public interface UtilisateurClient {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getUtilisateurById", targetNamespace = "model.webapp.librarypro.org", className = "org.librarypro.webapp.model.GetUtilisateurById")
    @ResponseWrapper(localName = "getUtilisateurByIdResponse", targetNamespace = "model.webapp.librarypro.org", className = "org.librarypro.webapp.model.GetUtilisateurByIdResponse")
    @Action(input = "model.webapp.librarypro.org/UtilisateurClient/getUtilisateurByIdRequest", output = "model.webapp.librarypro.org/UtilisateurClient/getUtilisateurByIdResponse")
    public UtilisateurDTO getUtilisateurById(
        @WebParam(name = "arg0", targetNamespace = "")
        int arg0);
